...
def objective(self, trial):
    ...
    path_manager = load_paths.Paths(self._h5_file_list, self._h5_locations, executing_mode, master_file) #good?
    ...
    for epoch in range(num_epoch):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            if batch_idx * batch_size >= N_TRAIN_EXAMPLES: #I am very unsure what N_TRAIN_EXAMPLES and N_VALID_EXAMPLES are so I'm leaving those for now
                break
